...
#-------------------------------------------------------------------------------------------
verify Login
    Login.Login                             ${purl}    ${StudentUsernameStg}       ${password}
...
#-------------------------------------------------------------------------------------------
Verify My Courses
    MyCourses.Verify My Courses page of Student User       ART BATCH ONE       TEST BATCH
...
Verify Course
    ...
    StudentCourseDashBoardPage.Verify Student user Pages of the Course          ${SPage}
    ...
    StudentCourseDashBoardPage.Verify Student user Project of the Course        ${Projects_name}             ${P_Description}      ${Pschool}       ${course}       ${module}          ${Project_Section_h}     ${Project_Section_description}
...
Verify Content Page
    ...
    ContentPage.Verify Content Page of Student User             ${SPage}          ${video}      ${Collection2}          ${Assignment}       ${Batch1}   All   ${Test}       ${StudentProject}   ${P_Description}      ${Pschool}       ${course}       ${module}          ${Project_Section_h}     ${Project_Section_description}
