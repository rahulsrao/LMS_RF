...
#-------------------------------------------------------------------------------------------
verify Login
     Login.Login                             ${purl}    ${AdminTeacher}       ${password}
...
Verify Course
    ...
    AdminCourseDashBoardPage.Verify Course LessonPlan                           ${Pschool}             ${LessonPlan}
...
verify System Settings page
    ...
    SystemSettings.Verify Admin Teacher User System Settings    ${level}        ${Course2}     ${Module}      ${Concept1}      ${Term}      ${OrgName}     ${Program}    ${Batch4}     ${StudentH}     ${BatchGrp}      ${prodStudent1}